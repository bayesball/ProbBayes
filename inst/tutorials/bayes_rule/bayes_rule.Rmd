...
Use the `bayesian_crank` function on `bayes_df` to compute the updated probabilities of the spinners.
...
The Prior and Posterior probabilities are stored in the data frame `bayes_df`.  Use the `prior_post_plot` function to compare the prior and posterior probabilities of the two spinners.
